...
// чистить данные в куках при каждом запросе +
// формировать массив на сонове куков
// хэшиорвать все куки, чтобы несколько раз не проходить по массиву
// добавть return в клининг хуков
